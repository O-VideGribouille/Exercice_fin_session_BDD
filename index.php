			 	...
			 	<ul id="Ul_nav" name="Ul_nav">
 					...
 					<li id="li_acc1" name="li_acc" class="list_nav">
  					...
  					<li id="li_login" name="li_login" class="list_nav"> 
  						...
  						<a href="./HTML/inscription.php" id="nav_acc2" name="nav_acc2" class="a_nav"> Inscription </a> 

  					</li>

  					<li id="li_login" name="li_login" class="list_nav"> 

  						<a href="./HTML/login.php" id="nav_acc3" name="nav_acc3" class="a_nav"> Connexion </a> 
...
<div id="divPrincipal" name="divPrincipal" class="divArticle">
	...
	<h2>Essai pour exercice Wamp </h2>

	<p>Ne pas prendre en compte le contenu hors cours.</p>
